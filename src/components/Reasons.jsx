...
const Reasons = () => {
    return (
        <section id="reasons" style={{ backgroundColor: '#fff', padding: '120px 0 80px 0', color: '#333' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem', maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <div style={{
                        ...
                        <p style={{ textAlign: 'left', fontSize: '0.95rem' }}>
                            企画・原稿・マンガ化・デザイン・ペーパーバック（紙本）化・SEO対策・出版手続き・販促まで、面倒な作業は全て代行いたします。コンテンツのご提供とヒアリングにご協力頂くだけ！（※特典準備等、一部ご協力の打診をすることがございます）
                        </p>
                    </div>
                    ...
                    <div style={{
                        ...
                        <h3 style={{ color: 'var(--color-secondary)', fontSize: '1.3rem', marginBottom: '1rem', borderBottom: '2px solid var(--color-accent)', display: 'inline-block', paddingBottom: '0.5rem' }}>
                            02：圧倒的な実績に基づく『Amazonから売れる』プロモーション支援
                        </h3>
                        <p style={{ textAlign: 'left', fontSize: '0.95rem' }}>
                            自分や生徒を併せて50冊以上のベストセラー実績に基づくプロモーション支援と、長年の経験に基づくSEO対策、構成作りで、Amazonから長く読まれる仕組み作りをお手伝いいたします。他社で良く見られる「無料キャンペーンによる販売数の嵩増し」「カテゴリーを移動させることによるAmazon〇冠アピール」のような本質的でない手法は一切に使いません。
                        </p>
                    </div>
                    ...
                    <div style={{
                        ...
                        <p style={{ textAlign: 'left', fontSize: '0.95rem' }}>
                            テキスト本とマンガでは、手に取られる層が全く異なります。我々にお任せいただければ、1冊分のお手間でテキストとマンガ両方の書籍を作成いたします。もちろんテキスト本かマンガ、どちらかだけお試しいただいて、追加のご注文を頂く形でも大歓迎です。（最安は2冊同時注文です）
                        </p>
                    </div>
                </div>
            </div>
