    ...
    return (
        ...
        <section style={{ backgroundColor: 'var(--color-secondary)', color: '#333', padding: '80px 0' }}>
            <div className="container" style={{ textAlign: 'center' }}>
                <h2 className="section-title" style={{ color: '#fff', textAlign: 'center', display: 'inline-block', borderBottom: '2px solid #fff', paddingBottom: '0.5rem' }}>運営者プロフィール</h2>
                <div className="grid grid-2">
                    ...
                    <div style={{ padding: '2rem', border: '1px solid #eee', borderRadius: '8px', backgroundColor: '#fff' }}>
                        ...
                        <p style={{ fontSize: '0.9rem', lineHeight: '1.8', textAlign: 'left' }}>
                            ...
                            ・LP漫画、漫画名刺、クライアントワーク対応多数実績あり<br />
                            ・8月に開催されるフェスイベントにAI漫画講師として登壇予定
                        </p>
                    </div>
                </div>
