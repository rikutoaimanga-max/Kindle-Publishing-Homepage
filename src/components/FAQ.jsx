...
const FAQ = () => {
    ...
    const questions = [
        ...
        },
        {
            ...
            a: 'ご安心ください。AIを補助的に使うことはあっても、丸投げで生成することはありません。25冊の出版経験を持つ作家とプロの構成担当が、あなたの過去の発信素材（SNS、YouTube等）を分析し、あなたの「言葉の癖」や「独自の視点」を活かした血の通った原稿を作成します。'
        },
        {
            q: 'Amazonランキング1位は本当に取れますか？',
            a: 'ベストセラーを狙いつつ、レコメンドを最大化するカテゴリ選定と、1.7万人の影響力を駆使したプロモーション、そしてAmazon SEOを組み合わせることで、高確率でランキング上位を狙います。特典や出版時のプロモーションにお力添えを頂ければ、更にその確率はアップいたします。ただし、私たちは「一瞬の1位」よりも、その後3年、5年と「集客し続けるロングセラー」にすることを最優先に設計します。'
        },
        {
            q: '出版後のサポートはありますか？',
            a: '出版直後のしゅーぞーとりくとによる拡散支援はもちろん、その後の「本の活用方法（バックエンド商品への繋げ方）」についても、カウンセリング時にアドバイスさせていただきます。本を出して終わりにせず、ビジネスの利益に繋げるまでをサポートの範囲と考えています。'
        }
    ];
